...
const Carousel = () => {
  ...
  {
    /* Mapping the urls from up above.
    Setting the useState to the first URL. Which will be the only image in display.
    The rest of the images will be opacity of 0 which wont show on screen. 
    When clicking the nextSlide or prevSlide, that one image will only be there/*/
  }
  return (
